            ...
            <div className="container py-4 flex items-center justify-between mx-auto text-sm xl:max-w-screen-xl max-2xl:px-6">
                <nav className="flex items-center gap-6">
                    ...
                    <div className="relative max-sm:hidden">
                        ...
                        <input type="search" name="Search" placeholder="Search..." className="w-auto py-2 pl-10 text-sm rounded-md focus:outline-none bg-gray-100 border border-gray-100 placeholder:text-gray-400 focus:border-violet-600 dark:bg-gray-900 dark:border-gray-800 dark:focus:border-violet-400 dark:placeholder:text-gray-600"/>
                    </div>
                </nav>
