            ...
            <div className="container p-6 mx-auto xl:max-w-screen-xl">
                <div className="flex gap-6 justify-between max-sm:flex-col">
                    <div className="">
                        ...
                        <a href="https://github.com/victor891263/crowdly" target="_blank" className="block mt-4 text-gray-600 dark:text-gray-300">
                    ...
                    <div>
                        <p className="font-bold text-black dark:text-white">Quick links</p>
