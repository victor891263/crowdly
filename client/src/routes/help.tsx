                        ...
                        <div className="lg:w-8/12 lg:border-r lg:pr-6 w-full">
                            ...
                            <div className="mt-12">
                                ...
                                <div className="grid-cols-2 md:grid-cols-3 mt-6 grid gap-4 sm:gap-[22px] font-semibold text-indigo-600 ">
                                    ...
                                    <Link to="/help/following users" className="shadow-sm flex flex-col items-center text-center p-6 border rounded-lg dark:bg-gray-800/75">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
                                        </svg>
                                        <div className="mt-2">Following users</div>
                                    </Link>
                                    <Link to="/help/posts and replies" className="shadow-sm flex flex-col items-center text-center p-6 border rounded-lg dark:bg-gray-800/75">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    ...
                                    <Link to="/help/likes and dislikes" className="shadow-sm flex flex-col items-center text-center p-6 border rounded-lg dark:bg-gray-800/75">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                                        </svg>
                                        <div className="mt-2">Likes and dislikes</div>
                                    </Link>
                                    <Link to="/help/quoting posts" className="shadow-sm flex flex-col items-center text-center p-6 border rounded-lg dark:bg-gray-800/75">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    ...
                                    <Link to="/help/your profile" className="shadow-sm flex flex-col items-center text-center p-6 border rounded-lg dark:bg-gray-800/75">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="max-lg:hidden w-4/12 pl-8 h-full">
                            <div className="flex gap-4">
                                <div>
                                    ...
                                    <a href='mailto:victor891263@gmail.com' target='_blank' rel="noreferrer" className="block mt-2.5 font-medium text-indigo-600 ">Send email</a>
                                </div>
                            </div>
                            <div className="flex gap-4 mt-8">
                                <div>
                                    ...
                                    <a href="https://github.com/victor891263/crowdly" target='_blank' rel="noreferrer" className="block mt-2.5 font-medium text-indigo-600 ">Visit GitHub</a>
                                </div>
                            </div>
                        </div>
                    </div>
